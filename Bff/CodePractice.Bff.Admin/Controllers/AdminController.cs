    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<Framework.Dto.FuncResult> Autorize([FromHeader] string token)
        {
            ...
            if (User == null)
            {
                ...
                return new Framework.Dto.FuncResult()
                {
                    ID = 0, Status = Framework.Dto.Status.Fail,
                    Error = new Framework.Dto.Error() {Code = "Z01", Message = "UnAutorizetion"}
                };
            }
        ...
        public async Task<Framework.Dto.FuncResult> UpdateToken([FromHeader] string token)
        {
            ...
            if (UserID == null)
            {
                ...
                {
                    ID = 0, Status = Framework.Dto.Status.Fail,
                    Error = new Framework.Dto.Error() {Code = "1", Message = "UnAutorizetion"}
                };
            }
